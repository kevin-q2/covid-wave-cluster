...
state_centers = pd.read_csv("state_centers.txt", sep = ',', index_col = 0)
...
translator_rev = {i[1]:i[0] for i in translator.items()}


state_centers.STNAME = [translator_rev[i] for i in state_centers.STNAME]
state_centers.drop('POPULATION', axis = 1, inplace = True)
state_centers.to_csv("state_centers.csv")